...
#' @param fp A Matrix containing every possible profile (combination of attributelevels).
#' @param fcomb A matrix containing in each row the to be considered profile combinations (choice sets).
